...
var $modalElement = document.querySelector('#editAdminModal');
var $addAdminModalElement = document.querySelector('#add-admin-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addAdminModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.admin-edit-button');
...
var editModalCloseBtn = document.querySelector('#editAdminModalCloseButton');
...
// search flow
var searchInput = document.querySelector('#table-search-admins');
var searchInputButton = document.querySelector('#table-search-admin-button');
...
var deleteButtons = document.querySelectorAll('.delete-admin-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-admin-id');
...
// restore flow
var restoreButtons = document.querySelectorAll('.restore-admin-btn');
restoreButtons.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!confirm('Are sure?')) return [3 /*break*/, 2];
                    id = e.getAttribute('data-admin-id');
                    return [4 /*yield*/, fetch("/admin/restore/".concat(id), {
                            method: 'POST',
                        })];
                case 1:
                    response = _a.sent();
...
function editAdmin(admin) {
    var input = document.querySelector('#admin-edit-username');
