...
// closing edit modal
var editModalCloseBtn = document.querySelector('#editUserModalCloseButton');
...
function editUser(user) {
    console.log(user);
    var input = document.querySelector('#user-edit-fullname');
