...
Revision ID: 70b5ff7a1255
Revises:
Create Date: 2024-03-06 11:08:51.702575
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['receiver_id'], ['users.id'], name=op.f('fk_rates_receiver_id_users')),
